...
namespace WoWAddonIDE
{
    public partial class MainWindow : Window
    {
        ...
        private void FileWatch_Stop()
        {
            ...
            catch (Exception ex) { LogService.Warn("FileWatch_Stop: failed to dispose file watcher", ex); }
            finally { _fsw = null; }
        }
        ...
        private void OnFsEventSafe(Action action)
        {
            ...
            catch (Exception ex) { LogService.Warn("OnFsEventSafe: failed to dispatch file system event", ex); }
        }
        ...
        private bool ShouldWatchThis(string path)
        {
            ...
            catch (Exception ex) { LogService.Warn("ShouldWatchThis: failed to check file extension", ex); return false; }
        }
