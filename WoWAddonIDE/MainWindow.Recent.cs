...
namespace WoWAddonIDE
{
    public partial class MainWindow : Window
    {
        ...
        private static List<string> Recent_Load()
        {
            ...
            catch (Exception ex) { LogService.Error("Recent_Load: failed to read recent projects file", ex); }
        ...
        private static void Recent_Save(List<string> items)
        {
            ...
            catch (Exception ex) { LogService.Error("Recent_Save: failed to write recent projects file", ex); }
        }
