...
namespace WoWAddonIDE
{
    public partial class MainWindow : Window
    {
        ...
        private void OpenStagingFolder_Click(object sender, RoutedEventArgs e)
        {
            ...
            try { System.IO.Directory.CreateDirectory(staging); } catch (Exception ex) { LogService.Warn("OpenStagingFolder_Click: failed to create staging directory", ex); }
