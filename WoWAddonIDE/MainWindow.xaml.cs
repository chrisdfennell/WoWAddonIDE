...
namespace WoWAddonIDE
{
    public partial class MainWindow : Window
    {
        ...
        private void SaveAs_Click(object? s, RoutedEventArgs e) => Status("Save As not implemented yet.");
        private void ToggleSidebar_Click(object? s, RoutedEventArgs e) => Status("Sidebar toggle not implemented yet.");

        // ===== FILE actions used by shortcuts =====
        private void SaveActiveTabShortcut() => Save_Click(this, new RoutedEventArgs());
        private void SaveAsActiveTab() => SaveAs_Click(this, new RoutedEventArgs());
        ...
        {
            // Hook up to your closed-tab history stack if/when you add one
            Status("Reopen Closed Tab not implemented yet.");
        }
        ...
        private void BuildChildren(TreeViewItem dirItem, DirectoryInfo dir)
        {
            ...
            try { subDirs = dir.GetDirectories(); } catch { /* ignore */ }
            try { files = dir.GetFiles(); } catch { /* ignore */ }
